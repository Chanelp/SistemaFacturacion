...
namespace SistemaFacturacion
{
    public partial class ContenedorPrincipal : Form
    {
        ...
        {
            ConsultarClientes ConsultarCli = new ConsultarClientes();
            ConsultarCli.MdiParent = this;
            ConsultarCli.Show();
        }

        private void productoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConsultarProductos ConsultarPro = new ConsultarProductos();
            ConsultarPro.MdiParent = this;
            ConsultarPro.Show();
        }
